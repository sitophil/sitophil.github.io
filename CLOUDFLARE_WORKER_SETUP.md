...
۱. در همان صفحه اول ورکر، آدرس URL ورکر خود را کپی کنید (چیزی شبیه `sitophil-contact-form.username.workers.dev`).
۲. فایل `index.html` سایت خود را باز کنید.
۳. در بخش اسکریپت‌ها، عبارت `YOUR_CLOUDFLARE_WORKER_URL` را پیدا کرده و آدرس ورکر خود را جایگزین آن کنید.
